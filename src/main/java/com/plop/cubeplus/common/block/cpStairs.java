...
public class cpStairs extends Block implements SimpleWaterloggedBlock
{
    ...
    public cpStairs(BlockState state, BlockBehaviour.Properties properties)
    {
        super(properties);
    ...
    public static boolean isBlockStairs(BlockState state) {
        return state.getBlock() instanceof cpStairs;
    }
